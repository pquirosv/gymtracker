  ...
  upper_lower: [
    ...
    },
    {
      ...
      slots: [
        ...
        ['Prensa de piernas', 'Extensión de cuádriceps', 'Subida al cajón'],
        ['Curl femoral', 'Empuje de cadera', 'Puente de glúteo'],
    ...
    },
    {
      ...
      slots: [
        ...
        ['Elevaciones laterales', 'Pájaros', 'Jalón a la cara'],
    ...
    },
    {
      ...
      slots: [
        ...
        ['Empuje de cadera', 'Peso muerto rumano', 'Puente de glúteo'],
        ['Extensión de cuádriceps', 'Subida al cajón', 'Sentadilla'],
        ['Curl femoral', 'Peso muerto rumano', 'Empuje de cadera'],
  ...
  push_pull_legs: [
    {
      ...
      slots: [
        ['Dominadas', 'Jalón al pecho'],
        ['Remo con barra', 'Remo con mancuerna', 'Remo en cable'],
        ['Jalón a la cara', 'Pájaros', 'Remo T'],
    ...
    },
    {
      ...
      slots: [
        ...
        ['Extensión de cuádriceps', 'Zancadas', 'Subida al cajón'],
        ['Curl femoral', 'Empuje de cadera', 'Puente de glúteo'],
        ['Elevación de gemelos de pie', 'Elevación de gemelos sentado'],
        ['Abdominales'],
      ],
